...
def get_args():
    ...
    parser.add_argument('-v', '--verifier', type=str, default='gt_test_cases/round1')
...
eval_dir = osp.join(gen_dir, 'refinement_results', args.verifier)
assert osp.exists(eval_dir)
vis_dir = osp.join(curdir, 'visualization', 'refinement_results', args.verifier)
